...
Ch = 1;  % Ch=0/1 for AWGN/multipath channel|对于AWGN/多径瑞利信道，channelCh=0/1 1
if Ch == 0
...
EbN0 = 0:5:20;      % EbN0
N_iter = 1e5;       % Number of iterations for each EbN0|对于每一个EbN0的迭代次数 1e5
...
for i=0:length(EbN0)
    ...
    for m = 1:N_iter
        ...
        X = randi(M,1,Nused*Nframe)-1; % bit: integer vector [0 M-1]随机生成
